...
{
    public class CheckoutService : IDartCheckout
    {
        public string getCheckout(string getal)
        {
            switch (getal)
            {
                case "170": return "T20 T20 50";
                case "167": return "T20 T19 50";
                case "164": return "T20 T18 50";
                case "161": return "T20 T17 50";
                ...
                case "145": return "T20 T19 D14";
                case "144": return "T20 T20 D12";
                case "143": return "T19 T18 D16";
                ...
                case "126": return "T19 T15 D12";
                case "125": return "T18 T13 D16";
                case "124": return "T20 T16 D8";
                case "123": return "T19 T14 D12";
                case "122": return "T18 T18 D7";
                case "121": return "T20 T11 D14";
                case "120": return "T20 20 D20";
                case "119": return "T19 T12 D13";
                case "118": return "T20 18 D20";
                case "117": return "T20 17 D20";
                case "116": return "T20 16 D20";
                case "115": return "T19 18 D20";
                case "114": return "T20 14 D20";
                case "113": return "T19 16 D20";
                case "112": return "T20 T12 D8";
                case "111": return "T19 14 D20";
                case "110": return "T20 10 D20";
                case "109": return "T20 9 D20";
                case "108": return "T19 19 D16";
                case "107": return "T20 15 D16";
                case "106": return "T20 6 D20";
                case "105": return "T19 8 D20";
                case "104": return "T20 T12 D4";
                case "103": return "T17 12 D20";
                ...
                case "56": return "T16 D4";
                case "55": return "15 D20";
                case "54": return "14 D20";
                case "53": return "12 D20";
                case "52": return "12 D20";
                case "51": return "11 D20";
                case "50": return "10 D20";
                case "49": return "9 D20";
                case "48": return "8 D20";
